...
class Students(Users):
    ...
    def delete_file(self, file_name):
        ...
        if course_name is not None:
            All_courses.get_object(course_name).files.remove(file_id)
...
class Files:
    ...
    def __init__(self, name, user_id, pathname, course_name, script=False, tag=None):
        ...
        if self.__course_name is not None:
            All_courses.get_object(self.__course_name).files.append(self.__file_id)
